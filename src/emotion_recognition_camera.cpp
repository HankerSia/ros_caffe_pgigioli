...
string model_path = "/media/ubuntu/emotion_recognition/emotion_deploy.prototxt";
string weights_path = "/media/ubuntu/emotion_recognition/emotion_VGG.caffemodel";
string mean_file = "/media/ubuntu/emotion_recognition/emotion_mean.binaryproto";
string label_file = "/media/ubuntu/emotion_recognition/labels.txt";
...
public:
   emotionRecognition()
   {
      faces_sub = nh.subscribe("/cropped_faces", 1, &emotionRecognition::imageCallback, this);
      labels_pub = nh.advertise<face_tracker::stringArray>("/emotion_labels", 1);
   }
...
{
   ros::init(argc, argv, "emotion_recognition_camera");
